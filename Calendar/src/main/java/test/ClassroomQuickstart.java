...
public class ClassroomQuickstart {
	...
	private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
		...
		GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow.Builder(HTTP_TRANSPORT, JSON_FACTORY,
				...
				// To have another data file stored instead say for example we are going to link users
				// we would do:
//				.setCredentialDataStore(new FileDataStoreFactory(new File(TOKENS_DIRECTORY_PATH)).getDataStore(FILE_NAME))
